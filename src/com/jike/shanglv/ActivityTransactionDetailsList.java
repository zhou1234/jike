...
public class ActivityTransactionDetailsList extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.putExtra("Details", list_details.get(arg2-1));
	...
	private void init() {
		...
		context = ActivityTransactionDetailsList.this;
	...
	protected void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("ActivityTransactionDetailsList"); // 统计页面
