...
public enum SPkeys {
	...
	SPNA("mySP_SuperCollection"), // SharedPreferences的名字

	userid("userid"), username("username"), userphone("userphone"), useremail(
			"useremail"), amount("amount"), // 虚拟账号金额
	siteid("siteid"), // 系统id
	...
	UserInfoJson("UserInfoJson"), lastUsername("lastUsername"), lastPassword(
			...
			"gnjpContactPhone"), // 国内机票下单，上次的联系人手机号码
	gjjpContactPhone("gjjpContactPhone"), // 国际机票需求单，上次的联系人手机号码
	hoteContactPhone("hoteContactPhone"), // 酒店订单，上次的联系人手机号码
